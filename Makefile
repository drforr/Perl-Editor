# This Makefile is for the Perl-Editor extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Pane.pm]
#     AUTHOR => q[Jeffrey Goff <drforr@pobox.com>]
#     NAME => q[Perl-Editor]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Pane.pm]
#     clean => { FILES=>q[Perl-Editor-*] }
...
EXE_EXT = 
FULL_AR = /usr/bin/ar
LD = cc -mmacosx-version-min=10.5.7
LDDLFLAGS = -arch ppc -arch i386 -bundle -undefined dynamic_lookup -L/usr/local/lib
LDFLAGS = -arch ppc -arch i386 -L/usr/local/lib
...
INSTALLPRIVLIB = /Library/Perl/Updates/5.8.8
DESTINSTALLPRIVLIB = $(DESTDIR)$(INSTALLPRIVLIB)
INSTALLSITELIB = /Library/Perl/5.8.8
DESTINSTALLSITELIB = $(DESTDIR)$(INSTALLSITELIB)
INSTALLVENDORLIB = /Network/Library/Perl/5.8.8
DESTINSTALLVENDORLIB = $(DESTDIR)$(INSTALLVENDORLIB)
INSTALLARCHLIB = /Library/Perl/Updates/5.8.8/darwin-thread-multi-2level
...
MAKEMAKER   = /Library/Perl/Updates/5.8.8/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.44
MM_REVISION = 54639
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Packer.pm \
	lib/Pane.pm \
	lib/Pane/CommandLine.pm \
	lib/Pane/Edit.pm \
	lib/Pane/StatusLine.pm \
	lib/SExpr/Edit.pm
...
PM_TO_BLIB = lib/Pane/StatusLine.pm \
	blib/lib/Pane/StatusLine.pm \
	lib/SExpr/Edit.pm \
	blib/lib/SExpr/Edit.pm \
	lib/Pane.pm \
	blib/lib/Pane.pm \
	lib/Packer.pm \
	blib/lib/Packer.pm \
	lib/Pane/Edit.pm \
	blib/lib/Pane/Edit.pm \
	lib/Pane/CommandLine.pm \
	blib/lib/Pane/CommandLine.pm
...
DISTNAME = Perl-Editor
DISTVNAME = Perl-Editor-0.0.3
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Pane/StatusLine.pm $(INST_MAN3DIR)/Pane::StatusLine.$(MAN3EXT) \
	  lib/SExpr/Edit.pm $(INST_MAN3DIR)/SExpr::Edit.$(MAN3EXT) \
	  lib/Pane.pm $(INST_MAN3DIR)/Pane.$(MAN3EXT) \
	  lib/Packer.pm $(INST_MAN3DIR)/Packer.$(MAN3EXT) \
	  lib/Pane/Edit.pm $(INST_MAN3DIR)/Pane::Edit.$(MAN3EXT) \
	  lib/Pane/CommandLine.pm $(INST_MAN3DIR)/Pane::CommandLine.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Jeffrey Goff &lt;drforr@pobox.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Pane/StatusLine.pm blib/lib/Pane/StatusLine.pm \
	  lib/SExpr/Edit.pm blib/lib/SExpr/Edit.pm \
	  lib/Pane.pm blib/lib/Pane.pm \
	  lib/Packer.pm blib/lib/Packer.pm \
	  lib/Pane/Edit.pm blib/lib/Pane/Edit.pm \
	  lib/Pane/CommandLine.pm blib/lib/Pane/CommandLine.pm 
